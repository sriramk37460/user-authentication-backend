...
public interface UserService {
    ...
    String resetPasswordRequest(PasswordRequestDTO passwordRequestDTO);
...
//    String editPhoneNumber(ChangePhoneNumberDTO changePhoneNumberDTO);
    ...
    String resetPasswordPermission(List<UserEditDTO> userEditDTOs) ;
    //    String editPhoneNumberPermission(UserEditDTO userEditDTO);
    String editEmailPermission(List<UserEditDTO> userEditDTOs) ;
    String accessPermission(List<UserEditDTO> userEditDTOs);
    String removeAccessPermission(UserEditDTO userEditDTO);
}
